...
* I have a demanding schedule outside of the class.  I did not complete in order to focus on upcoming topics and to take care of my top priorities that allow me to pay for this bootcamp.
...
* I did add a .gitignore file but was tld that it is not necessary with the load_dotenv() command
